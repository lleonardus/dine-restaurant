export function Footer() {
  return (
    <footer className="w-full bg-cod-gray px-5 py-20 text-center text-[14px] font-normal uppercase leading-7 tracking-[2px] text-white tablet:flex tablet:pl-[39px] tablet:text-left lg:pl-[165px]">
