export function RestaurantOverviewSection() {
  return (
    <section>
      <div className="flex flex-col items-center px-[24px] text-center tablet:bg-[url('/images/patterns/pattern-curve-top-right.svg')] tablet:bg-[length:50%_320px] tablet:bg-[left_top_100px] tablet:bg-no-repeat tablet:px-0 xl:flex-row xl:items-start xl:bg-auto xl:bg-[left_top_250px] xl:px-[165px] xl:text-left">
        <div className="mb-[48px] h-[400px] w-[327px] shrink-0 translate-y-[-72px] bg-[url('/images/homepage/enjoyable-place-mobile.jpg')] bg-center bg-no-repeat shadow-[0px_100px_80px_-30px_rgba(0,0,0,0.25)] tablet:mb-[0px] tablet:h-[360px] tablet:w-[573px] tablet:translate-y-[-96px] tablet:bg-[url('/images/homepage/enjoyable-place-tablet.jpg')] tablet:shadow-[0px_100px_80px_-40px_rgba(0,0,0,0.25)] xl:relative xl:h-[720px] xl:w-[540px] xl:translate-y-[-70px] xl:bg-[url('/images/homepage/enjoyable-place-desktop.jpg')] xl:bg-center"></div>
