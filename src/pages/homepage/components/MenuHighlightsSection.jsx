export function MenuHighlightsSection() {
  return (
    <section className="bg-black pb-[102px] pt-[72px] text-center text-white tablet:pb-[96px] tablet:pt-[96px] xl:flex xl:gap-[125px] xl:pb-[120px] xl:pl-[165px] xl:pt-[200px] xl:text-left desktop:justify-between desktop:px-[165px]">
      ...
      <ul className="mt-[85px] flex shrink-0 flex-col items-center divide-y divide-solid divide-beaver tablet:mt-[54px] tablet:text-left">
