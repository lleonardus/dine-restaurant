...
export function BookYourTableSection() {
  return (
    <section className="flex flex-col items-center gap-5 bg-black bg-[url('/images/homepage/ready-bg-mobile@2x.jpg')] bg-cover bg-no-repeat px-6 pb-20 pt-[84px] tablet:bg-[url('/images/homepage/ready-bg-tablet@2x.jpg')] tablet:pb-16 tablet:pt-[72px] xl:flex-row xl:gap-[100px] xl:bg-[url('/images/homepage/ready-bg-desktop@2x.jpg')] xl:px-[165px] xl:py-[88px] xl:*:shrink-0 desktop:gap-[250px] desktop:px-[240px]">
